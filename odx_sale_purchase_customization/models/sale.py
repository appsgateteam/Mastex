...
class SaleOrder(models.Model):
    ...
    sale_landing_eta = fields.Date(string='ETA', compute='_compute_sale_eta',store=True, track_visibility='always')
    sale_landing_etd = fields.Date(string='ETD', compute='_compute_sale_eta',store=True, track_visibility='always')
    ...
    def _get_invoice_status(self):
        ...
        for order in confirmed_orders:
            ...
            elif line_invoice_status and any(invoice_status == 'invoiced' for invoice_status in line_invoice_status):
...
class SaleOrderLine(models.Model):
    ...
    def product_id_change(self):
        ...
        return res@api.onchange('product_id')
    def product_id_change(self):
